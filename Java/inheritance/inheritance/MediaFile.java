...
public class MediaFile {
	...
	class DemoMediaFile {
	    public static void main(String[] args) {
	        ...
	        AudioFile a = new AudioFile("song.mp3", 5.2, 210, "MP3", "Audio",
	                320, 2, "Arijit Singh", 48000, "Hindi");
	        a.display();
	        System.out.println("\n");

	        VideoFile v = new VideoFile("movie.mp4", 750.0, 7200, "MP4", "Video",
	                "1920x1080", "Rajkumar Hirani", "16:9", 120.0, "Hindi", "H.265");
	        v.display();
	        System.out.println("\n");

	        ImageFile i = new ImageFile("wallpaper.jpg", 2.5, 0, "JPEG", "Image",
	                "1920x1080", 32, "Landscape", 300, "Vintage", "PNG");
	        i.display();
	    }
	}
