...
public class Defence {
	...
	void attack()
	{
		System.out.println("Attack on different ways");
	}
...
class DemoDefence
{
	public static void main(String[] args) {
        ...
        System.out.println("\n--- Army (Parameterized) ---");
       d1 = new Army("General Singh", 120, 9500000, 10, 5, "Delhi", 500, 200, 25,
                           100, 300, 500, 8);//upcasting
       d1.attack();
        d1.display();

        System.out.println("\n--- Navy (Parameterized) ---");
        d1 = new Navy("Admiral Rajesh", 80, 8000000, 8, 3, "Mumbai", 300, 150, 20,
                           20, 10, 50);//upcasting
        d1.attack();
        d1.display();

        System.out.println("\n--- AirForce (Parameterized) ---");
       d1 = new AirForce("Air Marshal Verma", 150, 12000000, 12, 2, "Pune", 400, 180, 30,
                                    60, 25, 5);//upcasting
       d1.attack();
        d1.display();
	}
