	...
	class DemoGame {
	    public static void main(String[] args) {
	       ...
	       g1= new Cricket("World Cup Final", "Outdoor", 11, 300, "Standard", 250,
	        ...
	        g1.display();
	       System.out.println("total score is::"+ g1.calculateScore());
	        System.out.println("\n");
	       ...
	       System.out.println("total score is::"+ g1.calculateScore());
	        ...
	        g1 = new Basketball("NBA Finals", "Indoor", 5, 48, "NBA Rules", 102,
	                "New York", "20:00", "22:00", "Lakers", "Lakers", "23",
	                102, 8, 15, 10, 6, "Hardwood");//upcasting
	        System.out.println("total score is::"+ g1.calculateScore());
	        g1.display();
	    }
	}
