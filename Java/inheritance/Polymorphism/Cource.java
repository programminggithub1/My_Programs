...
public class Cource {
	...
	void conduct() {
        System.out.println("Course is being conducted in general mode.");
    }
	 String getName() {
		return name;
	}
	...
	class OnlineCource extends Cource
	{
		...
		void conduct() {
	        System.out.println("Course is being conducted online via platform.");
	    }
	...
	class offlineCource extends Cource
	{
		...
		void conduct() {
	        System.out.println("Course is being conducted in classroom.");
	    }
		 String getRoomno() {
			return roomno;
		}
	...
	class HybridCourse extends Cource {
	    ...
	    void conduct() {
	        System.out.println("Course is being conducted both online and offline.");
	    }
	...
	public static void main(String[] args) {
		Cource c1;//generic reference
		 c1 = new OnlineCource("Java Full Stack", 6, "01/01/2025", "30/06/2025",
				 "English", true, 50000, "Udemy", "https://udemy.com/java123", true); //upcasting
		 c1.conduct(); 
		 c1.display();
	     System.out.println("\n");
	        
	       c1 = new offlineCource("Data Science", 8, "10/02/2025", "10/10/2025",
	    		   "English", true, 65000, "Room 204", "9 AM - 3 PM", 60, 12, true); //upcasting
	        c1.conduct();
	        c1.display();
	        System.out.println("\n");
	        
	      c1 = new HybridCourse("AI and ML", 10, "05/03/2025", "05/12/2025",
	    		  "English", true, 80000, "Zoom", "Pune Center", 8, 6, true);//upcasting 
	        c1.conduct();
	        c1.display();
